Contract security measures SWC-103 (Floating pragma) Specific compiler pragma 0.8.14 used in contracts to avoid accidental bug inclusion through outdated compiler versions.
